SET session_replication_role = 'replica';
	...
	delete from algafood.restaurante_usuario_responsavel;
	...
	ALTER SEQUENCE algafood.item_pedido_id_seq RESTART WITH 1;
	ALTER SEQUENCE algafood.pedido_id_seq RESTART WITH 1;
...
values (5, '8d774bcf-b238-42f3-aef1-5fb388754d63', 1, 3, 2, 1, '38400-200', 'Rua 10', '930', 'Casa 20', 'Martins',
        'ENTREGUE', '2019-11-02 02:00:30', '2019-11-02 02:01:21', '2019-11-02 02:20:10', 87.2, 10, 97.2);
